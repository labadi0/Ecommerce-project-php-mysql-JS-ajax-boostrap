<?php
                          ...
                          $item_numero = '04AAAb'; /*Numéro du produit en vente*/
                          $item_prix   = q["prix"];    /*prix du produit*/
                          $item_nom    = $smp->getModele() ; /*Nom du produit*/
                          /*
                          ...
                          */
                          $url_retour='https://bazare-ucp.000webhostapp.com/remerciement.php?id_numero='.$item_numero; /* page de remerciement à créer */
                          $url_cancel='https://bazare-ucp.000webhostapp.com/'; /*page d'annulation d'achat */
                          $url_confirmation='https://bazare-ucp.000webhostapp.com/remerciement.php?conf="oui"'; /*page de confirmation d'achat */
